...
public class WriteMultipleDataToExcel {
	...
	public static void main(String[] args) throws Throwable {
			...
			Sheet sheet=book.getSheet("Sheet3");//get the control of sheet
			...
			{
				Row row=sheet.createRow(i);//2//get the control of row
				
				//for(int j=0;j<row.getLastCellNum();j++)
				//{
				Cell cell=row.createCell(0);//5//get the control of cell
				cell.setCellValue(allLinks.get(i).getAttribute("href"));//create value
